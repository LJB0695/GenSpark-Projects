...
public class Land {
    ...
    public String goblinNameGenerator() {
        String[] goblinNames = {"Thovaass", "Balizz", "Sluzz", "Vreevrog", "Woing", "Crozdeegz", "Iobs", "Xodrogs", "Gis", "Stiokz", "Filhisz", "Wulgold", "Heepvogs", "Bresxee", "Pielkee"};
    ...
    public Goblin goblinFightMechanics(HashMap<Integer, int[]> humanCoordinates, ArrayList<Goblin> arrList) {
        ...
        for (Goblin g : arrList) {
            if (g.row == humanCoordinates.get(0)[0] && g.col == humanCoordinates.get(0)[1]) {
                fighter = g;
            }
        }
        return fighter;
